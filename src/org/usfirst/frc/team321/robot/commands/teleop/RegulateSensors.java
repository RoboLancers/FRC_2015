...
public class RegulateSensors extends Command {
	...
	protected void execute() {
		...
		//Infrared Sensor
		SmartDashboard.putBoolean("Left VL" ,Robot.feedback.leftVL.get());
		SmartDashboard.putBoolean("Right VL" ,Robot.feedback.rightVL.get());

		SmartDashboard.putBoolean("Tote Detector Low" ,Robot.feedback.toteDetectorLow.get());
		SmartDashboard.putBoolean("Tote Detector High" ,Robot.feedback.toteDetectorHigh.get());
	}
